...
const GroupResources = ({overview_id}) => {

    const [inputList, setInputList] = useState([{ group_overview_desc: "" }]);
    ...
    const handleAddClick = () => {
        setInputList([...inputList, { group_overview_desc: "" }]);
    };
    ...
    const handleAddGroupResource = (e, index) => {
        ...
        const data = {
            ...
            description:list[index].group_overview_desc
        }
                ...
                return (
                    <div key={i}>
                        ...
                        >
                            <TextField
                                fullWidth
                                name="group_overview_desc"
                                value={x.group_overview_desc}
