            ...
            <div className="container">
                ...
                <Fade left cascade>
                    ...
                    <div className="col-12 col-md-7 col-lg-6 order-lg-1">
                        ...
                        <p className="lead text-muted mt-4"><span className="font-weight-bold">The Intentional Learning Testing Platform</span> is a unique technology that tests for and identifies the causes of learning difficulties and offers expert guidance to help learners improve in their learning outcomes in record time.
                        </p>
                        <div className="col-12 d-md-none">
