                ...
                <div className="col-12">
                    <div className="progress-wrapper">
                        ...
                        <div className="progress progress-xl">
                            <div className={`progress-bar bg-${props.color}`} role="progressbar" aria-valuenow={`${props.progress}`} style={{ width:props.progress+'%' }} aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            </div>
