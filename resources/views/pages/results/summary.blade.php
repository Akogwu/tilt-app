    ...
    <section class="my-4">
        ...
        <div class="container">
            <div class="flex flex-col align-items-center py-6">
                <a href="{{route('result.view', $sessionId)}}" type="button" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
