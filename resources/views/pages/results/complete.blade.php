...
@section('content')
    ...
    <section class="my-4">
        <div class="container">
            <div class="shadow bg-gray-50 w-full h-full rounded">
                <div class="flex flex-col align-items-center py-4 bg-gray-50 relative">
                    <img src="/images/tilt-logo.svg" class="h-10 w-10 absolute top-10 left-10" alt="">
                    ...
                    <div class="p-2 border border-1 border-indigo-700 rounded-lg bg-white">
                        <span class="">Here is the complete result of your test</span>
                    </div>
                </div>
